...
const Rules = (props) => {
    ...
    const rulesText = 'Компьютер задумывает различные цифры из 0,1,2,...9 (количество зависит от выбранного уровня сложности). Игрок делает ходы, чтобы узнать эти цифры и их порядок, 0 может стоять на первом месте. В ответ компьютер показывает число отгаданных цифр, стоящих на своих местах (число быков) и число отгаданных цифр, стоящих не на своих местах (число коров).'
