    ...
    return (
        <div>
            <div className="underTitle">
                <Link to='/rules' className='link'><button className="button" >Правила игры</button></Link>
                <Link to='/gamehistory' className='link'><button className="button" >История</button></Link>
                <div>
